...
module.exports = function (webpackEnv) {
  ...
  return {
    ...
    plugins: [
      ...
      // Generates an `book.html` file with the <script> injected.
      new HtmlWebpackPlugin(
        Object.assign(
          {},
          {
    ...
    performance: false,
    /*
    Adding this line because we are seeing a lot of warnings related to failure to parse source map after upgrade to webpack 5.x
    Reference: https://github.com/facebook/create-react-app/discussions/11767 and open PR: https://github.com/facebook/create-react-app/pull/11752
    */
